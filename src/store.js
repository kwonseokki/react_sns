...
// const isOpenComment = createSlice({
//     name : "isOpenComment",
//     initialState : {
//         status : false,
//         userPost : []
//     },
//     reducers : {
//         setOpenComment(state, action) {
//             if(!(action.payload.status)) {
//             state.userPost=action.payload.currentPost;
...
// export let { setOpenComment } = isOpenComment.actions;
...
export default configureStore({
    reducer: { 
        isLogin : isLogin.reducer,  // 작명 : 가져다쓸 state
